...
- Checklist de requisitos: [docs/checklist-requisitos-entrega.md](docs/checklist-requisitos-entrega.md)
- Relatorio formal de entrega: [docs/relatorio-entrega.md](docs/relatorio-entrega.md)
